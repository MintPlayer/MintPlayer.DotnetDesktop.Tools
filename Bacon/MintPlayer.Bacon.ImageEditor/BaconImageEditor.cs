...
public class BaconImageEditor : UserControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        // Draw control points for shapes
        DrawControlPoints(g);
    ...
    private void DrawControlPoints(Graphics g)
    {
        ...
        // Draw control points for all shapes in shape layers
    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        if (e.Button == MouseButtons.Left && _image != null)
        {
            ...
            // Check if clicking on a control point of the selected shape
            ...
            foreach (var layer in _image.Layers.OfType<ShapeLayer>())
            {
                ...
                for (int i = layer.Shapes.Count - 1; i >= 0; i--)
                {
                    ...
                    // Check if clicking inside shape bounds
    ...
    private Point ImageToScreen(PointF imagePoint)
    {
        return new Point(
            (int)(imagePoint.X * _zoom + _panOffset.X),
            (int)(imagePoint.Y * _zoom + _panOffset.Y));
    }
