...
public partial class KarnaughMap : UserControl
{
    public KarnaughMap()
    {
        ...
        loops_ones = new ObservableCollection.ObservableCollection<QuineMcCluskey.RequiredLoop>();
        loops_zeros = new ObservableCollection.ObservableCollection<QuineMcCluskey.RequiredLoop>();
